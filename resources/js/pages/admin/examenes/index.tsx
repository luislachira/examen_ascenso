                ...
                <tbody>
                    ...
                    return (
                        ...
                        <td className="examenes-td-examen">
                            ...
                            {examen.descripcion && (
                                <div
                                  className="text-sm text-gray-500 mt-1 line-clamp-1 prose prose-sm max-w-none"
                                  title={extraerTextoPlano(examen.descripcion)}
                                  dangerouslySetInnerHTML={{ __html: examen.descripcion }}
                                />
                            )}
